...
# After creating the certificate, an authenticator.sh script  will be called to approve the DNS challenge on FlexibleEngine.  Next pushing the certificate to FlexibleEngine ELB. and assign it to the ELB HTTPS listener.
...
# Obtaining Token on a specified project eu-west-0_XXXXX.
echo 'Authenticating and getting FE Token..'
